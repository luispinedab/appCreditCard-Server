...
var getUsers = function (req, res) {
    ...
    return dbActions_1.dbActions.read(User_1.User, req, res, relations);
};
exports.getUsers = getUsers;
var updateUser = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var hashencriptedNumber, today, date, time, dateTime;
    return __generator(this, function (_a) {
        hashencriptedNumber = cryptr.encrypt(req.body.Password);
        ...
        return [2 /*return*/, dbActions_1.dbActions.update(User_1.User, req, res)];
    });
}); };
exports.updateUser = updateUser;
var deleteUser = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        return [2 /*return*/, dbActions_1.dbActions.delete(User_1.User, req, res)];
    });
}); };
